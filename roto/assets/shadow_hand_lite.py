...
SHADOW_HAND_LITE_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        asset_path=f"/home/ayush/icra/Roto-on-ShadowLite/roto/assets/shadow_lite/sr_hand.urdf", #change path
        usd_dir=f"/home/ayush/icra/Roto-on-ShadowLite/roto/assets/shadow_lite/",
